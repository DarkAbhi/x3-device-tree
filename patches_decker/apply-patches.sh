...
cd ../../../..
cd system/core
git apply -v ../../device/LeTV/x500/patches_decker/0001-Remove-CAP_SYS_NICE-from-surfaceflinger.patch
git apply -v ../../device/LeTV/x500/patches_decker/0004-libnetutils-add-MTK-bits-ifc_ccmni_md_cfg.patch
git apply -v ../../device/LeTV/x500/patches_decker/0012-PATCH-xen0n-some-MTK-services-e.g.-ril-daemon-mtk-re.patch
cd ../..
cd bionic
...
cd ../..
cd frameworks/base
git apply -v ../../device/LeTV/x500/patches_decker/0013-PackageManager-don-t-delete-data-app-mcRegistry-fold.patch
cd ../..
